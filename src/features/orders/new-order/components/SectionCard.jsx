export default function SectionCard({ section, isSelected, onSelect }) {
  return (
    <button
      ...
      className={`section-item group flex cursor-pointer items-center justify-between rounded-xl border border-primary/10 p-4 shadow-sm transition-all duration-200 ${
