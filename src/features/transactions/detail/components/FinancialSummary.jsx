    ...
    <section className="rounded-xl bg-surface-container-lowest p-6 shadow-md ring-1 ring-on-surface/5">
      ...
      <div className="mb-6 space-y-4">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className="font-medium text-on-surface">{formatMoney(financial.platformFee)}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span className="text-on-surface-variant">{financial.vatLabel}</span>
          <span className="font-medium text-on-surface">{formatMoney(financial.vatAmount)}</span>
        </div>
      ...
      <div className="space-y-3 rounded-xl bg-surface-container-low p-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-label text-[10px] font-bold uppercase text-on-surface-variant">Payment Mode</p>
