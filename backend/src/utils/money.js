 ...
 * Accepts integers and up to 2 decimal places (paise).
 */
function parseRupeePrice(raw) {
...
function formatRupeePrice(price) {
  const n = parseRupeePrice(price)
  if (Number.isInteger(n)) return String(n)
  return n.toFixed(2)
}

module.exports = { parseRupeePrice, formatRupeePrice }
